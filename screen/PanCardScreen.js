...
export default function PanCardScreen({navigation}) {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.titleText}>Let's find your PAN card</Text>
        <Text style={styles.description}>
          Enter your PAN card number and we'll get the required information from
          the NSDL. Or you can upload your PAN card instead.
        </Text>
        <Image
